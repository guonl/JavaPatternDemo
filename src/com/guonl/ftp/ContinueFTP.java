...
public class ContinueFTP {
	...
	public static void main(String[] args) {
		...
		try {
			myFtp.connect("192.168.2.60", 21, "share", "123456");
			myFtp.ftpClient.makeDirectory(new String("图片".getBytes("UTF-8"),
					"iso-8859-1"));
...
//			 String("电视剧".getBytes("GBK"),"iso-8859-1"));
			...
			// System.out.println(myFtp.upload("E://yw.flv", "/yw.flv",5));
			 System.out.println(myFtp.upload("E://ftp-test//123.jpg","/图片/123.jpg"));
//			System.out.println(myFtp.download("/123/123.jpg",
//					"E://ftp-test//123.jpg"));
			myFtp.disconnect();
		} catch (IOException e) {
